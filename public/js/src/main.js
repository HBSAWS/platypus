	...
	var Platypus = {
		...
		dataTables: function() {
			...
			function initTable($tbl, bButtons) {
				...
				let btnMarkup = bButtons ? "<'row'<'col-xs-4 text-xs-left'B><'col-xs-6 text-xs-left'f><'col-xs-2 text-xs-right'l>><'row'<'col-xs-12'tr>><'row'<'col-sm-6 col-xs-12 small'i><'col-sm-6 col-xs-12'p>>" : "<'row'<'col-xs-10 text-xs-left'f><'col-xs-2 text-xs-right'l>><'row'<'col-xs-12'tr>><'row'<'col-sm-6 col-xs-12 small'i><'col-sm-6 col-xs-12'p>>";
			...
			$('.datatable').each(function() {
				...
				if(buttons) {
					...
					p = Promise.all([
			            load.css("https://cdn.datatables.net/buttons/1.3.1/css/buttons.dataTables.min.css"),
			            load.js("https://cdn.datatables.net/buttons/1.3.1/js/dataTables.buttons.min.js"), 
			            load.js("https://cdnjs.cloudflare.com/ajax/libs/jszip/3.1.3/jszip.min.js"),
			            load.js("https://cdn.rawgit.com/bpampuch/pdfmake/0.1.27/build/pdfmake.min.js"),
			            load.js("https://cdn.rawgit.com/bpampuch/pdfmake/0.1.27/build/vfs_fonts.js"),
			            load.js("https://cdn.datatables.net/buttons/1.3.1/js/buttons.html5.min.js"),
			            load.js("https://cdn.datatables.net/buttons/1.3.1/js/buttons.print.min.js"),
			            load.js("https://cdn.datatables.net/buttons/1.3.1/js/buttons.colVis.min.js"),
		          	]);
	        	}
